...
# Old way using style_id: table.style = 'LightShading-Accent1'
# New way using style name:
table.style = 'Light Shading Accent 1'
# More styles: https://python-docx.readthedocs.io/en/latest/user/styles-understanding.html
# Table data
genes = (
